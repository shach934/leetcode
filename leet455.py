...
# children are 1, 2, 3. And even though you have 2 cookies, since their size is both 1, 
# you could only make the child whose greed factor is 1 content. You need to output 1.
